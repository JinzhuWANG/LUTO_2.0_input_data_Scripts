...
# SNES area-weighted score calculation removed — script_5_2 computes Australia-level
# and all regional scores from bio_DCCEEW_SNES.nc using compute_region_scores().
...
# ECNES area-weighted score calculation removed — script_5_2 computes Australia-level
# and all regional scores from bio_DCCEEW_ECNES.nc using compute_region_scores().
